...
namespace Better.StreamingAssets
{
    public class SubReadOnlyStream : Stream
    {
        ...
        public Stream actualStream
        {
            ...
            set
            {
                m_actualStream = value;

                if (m_actualStream != null && m_actualStream.Position != m_position)
                {
                ...
                //{
                //    Debug.Assert(m_offset <= actualStream.Length);
                //    Debug.Assert(actualStream.Length >= m_length);
                //    Debug.Assert(m_offset + m_length <= actualStream.Length);
                //}
            }
        }
