...
public class Rope : MonoBehaviour
{
    ...
    public Quaternion[] currentNodeRotations;
    ...
    private void AdjustCollisions()
    {
        for (int i = 0; i < totalNodes; i++)
        {
            ...
            //Debug.Log(result+"  " + currentNodePositions[i]);
            // if (result > 0)
            // {
            for (int n = 0; n < result; n++)
            {
                // if (colliderHitBuffer[n].gameObject.layer != 8)
                {
                    ...
                    Physics.ComputePenetration(nodeCollider, currentNodePositions[i], Quaternion.identity, colliderHitBuffer[n], colliderPosition, colliderRotation, out var dir, out distance);
    ...
    private void ApplyConstraint(int test)
    {
        ...
        //Debug.Log(currentNodePositions[0] + "  " + currentNodePositions[totalNodes - 1]);
        ...
        for (int i = 0; i < totalNodes - 1; i++)
        {
            ...
            Vector3 direction = Vector3.one* 0.001f;
            ...
            //Debug.LogError(test+"  "+totalNodes+"  "+i+"  "+node1+"  "+node2+"  "+currentDistance+ "  "+nodeDistance + "  "+direction + "  "+difference+"  "+ movement + "  " + stiffness);
            // apply correction
    ...
    void SetAngles()
    {
        for (int i = 0; i < totalNodes - 1; i++)
        {
            ...
            //currentNodeRotations[i] *= Quaternion.Euler(90, 0, 0);
            if (i % 2 == 0 && i != 0)
            {
